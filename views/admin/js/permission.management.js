...
function editPermission(id){
  ...
  $.ajax({
    type: "POST",
    url: "admin/inc/ajax/permission_getdata.php",
...
function permissionRolesList(id) {
  ...
  $.ajax({
    type: "POST",
    url: "admin/inc/ajax/permission_getroles.php",
    data: { "permission_id": id, "csrf_token": $('meta[name="csrf_token"]').attr("value") },
    beforeSend: function(){
      $.LoadingOverlay('show', {
        image: '../login/images/Spin-0.8s-200px.svg',
...
$('#saveRoles').click(function(){
    ...
    $.ajax({
      type: "POST",
      url: "admin/inc/ajax/permission_updateroles.php",
      processData: false,
      contentType: false,
      data: sendData,
      beforeSend: function(){
...
$(document).ready(function() {
  permissionTable = $('#permissionList').DataTable({
    ...
    paging: true,
    ajax: {
      url: "admin/inc/ajax/permissions_getall.php?csrf_token="+ $('meta[name="csrf_token"]').attr("value"),
      error: function (xhr, error, thrown) {
...
$("#newPermissionForm").submit(function(event){
    ...
    $.ajax({
      url: "admin/inc/ajax/permissions_add.php",
      type: "POST",
  ...
  $("#editPermissionForm").submit(function(event){
    ...
    $.ajax({
      url: "admin/inc/ajax/permission_update.php",
      type: "POST",
