...
if ($this->admin_verify == 'true') {
    ...
    $verify_btn = '<p><a href="'.$verify_url.'" class="btn btn-primary">Verify Your Account</a></p>';
}
                        ...
                        <tr>
                            <td>
                                <div class="text" style="padding: 0 2.5em; text-align: center;">
                                    <h3>'.$this->site_name.' Account Verification</h2><br>
                                    <h4>'.$usr['username'].' '.$verify_email_msg.'</h4>
                                    '.$verify_btn.'
                                </div>
                            </td>
                        </tr>
