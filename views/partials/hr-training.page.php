...
const DES_DIR = HRF_DIR . 'training_doc/';
const DES_URL = HRF_URL . 'training_doc/';
?>
<section class="content">
    <div class="container-fluid">
        <table id="training_docs" class="table table__plain table-hover">
            <thead>
            <tr>
                <th>Description</th>
                <th>Language</th>
            ...
            foreach($files as $file) {
                ...
                echo '<tr>
                        ...
                        <span><i class="icon-docs"></i></span> '.$path_parts['filename'].'
                          <br>
                          <small>
                              ['.$path_parts['extension'].', '.$file_size.' MB] <a href="viewer.php?t=pdf&dt=training_doc&dn='.$path_parts['filename'].'">View</a>
                          </small>
                      </td>
                <td>English</td>
                <td>00</td>
