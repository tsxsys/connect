    ...
    <div class="container-fluid">
        <div class="row">
            <div class="btn_tr_xtra">
                <div class="mb-3">
                    <a href="functions.php?t=contact-details" class="btn btn-warning pull-right btn-sm" style="margin-right: 10px;">View Detailed</a>
                </div>
            </div>
            <div class="col-12">
                <div class="card">
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table id="phonebookList" class="table table-sm ecnis_x_table_clean">
                            <thead>
                            <tr>
                                <th>Id</th>
                                <th>Name</th>
