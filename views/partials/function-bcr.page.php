 ...
 **/
//$calendar = (new Connect\Calendar);
include('' . VIEWS_URL . 'functions/inc/ajax/calendar/loader.php');
$_SESSION['token'] = time();
?>
<!-- Main content -->
<section class="content">
    <div class="container-fluid">
        <div class="row">
            ...
            echo '<div class="admin_calendar_xtra">
                <div class="mb-3">
                    <a href="' . VIEWS_URL . 'functions/inc/ajax/calendar/export.php" class="btn btn-warning pull-right btn-sm" style="margin-right: 10px;">Export</a>
                    <a href="#cal_import" class="btn btn-info pull-right btn-sm" data-toggle="modal"
                       style="margin-right: 10px;">Import</a>
                </div>
            </div>';}?>
            <div class="col-md-12">
                    ...
                    <div class='card-body'>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form id="modal-form-body">
                                            ...
                                            <p>
                                                ...
                                                <input type="text" class="form-control input-sm" value="#587ca3"
                                                       name="color" id="colorp">
                                            </p>
                                            <div class="pull-left mr-10">
                                                <p id="repeat-type-select">
                                                    <label>Repeat:</label>
                                                    <select id="repeat_select" name="repeat_method"
                                                            class="form-control">
                                                ...
                                                <div class="pull-left mr-10">
                                                    <p>
                                                        ...
                                                        <input type="text" name="start_date"
                                                               class="form-control input-sm" placeholder="Y-M-D"
                                                               id="startDate">
                                                    </p>
                                                </div>
                                                <div class="pull-left">
                                                    <p>
                                                        ...
                                                        <input type="text" class="form-control input-sm"
                                                               name="start_time" placeholder="HH:MM" id="startTime">
                                                    </p>
                                                </div>
                                                <div class="clearfix"></div>
                                                <div class="pull-left mr-10">
                                                    <p>
                                                        ...
                                                        <input type="text" class="form-control input-sm" name="end_date"
                                                               placeholder="Y-M-D" id="endDate">
                                                    </p>
                                                </div>
                                                <div class="pull-left">
                                                    <p>
                                                        <label>End Time:</label>
                                                        <input type="text" class="form-control input-sm" name="end_time"
                                                               placeholder="HH:MM" id="endTime">
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="clearfix"></div>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="#" class="btn btn-danger" data-option="remove-repetitives">Delete
                                            all</a>
                        ...
                        <div id="cal_import" class="modal fade">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">Import Event</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    ...
                                    <div class="modal-body">
                                        <div class="modal-body-import" style="white-space: normal;">
                                            <p class="help-block">Copy & Paste the event code from your .ics file, open it
                                                using an text editor</p>
                                            <textarea class="form-control" rows="10" id="import_content"
                                                      style="margin-bottom: 10px;"></textarea>
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                                        <input type="button" class="pull-right btn btn-info"
                                               onClick="calendar.calendarImport()" value="Import"/>
                                    </div>
