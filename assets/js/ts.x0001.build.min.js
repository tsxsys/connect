...
function init_flot_chart() {
    if ("undefined" != typeof $.plot) {
        ...
        var g = {
            ...
            colors: ["rgba(42,62,84,0.38)", "rgba(52, 152, 220, 0.12)"],
            xaxis: {
        ...
        $("#chart_plot_01").length && (console.log("Plot1"), $.plot($("#chart_plot_01"), [a, b,], g)), $("#chart_plot_02").length && (console.log("Plot2"), $.plot($("#chart_plot_02"), [{
            label: "Email Sent",
            data: d,
            lines: {fillColor: "rgba(52, 152, 220, 0.12)"},
            ...
            points: {fillColor: "#fff"}
        }], i)), $("#chart_plot_04").length && (console.log("Plot4"), $.plot($("#chart_plot_04"), [{
            data: a, b,
            lines: {fillColor: "rgba(52, 152, 220, 0.12)"},
            points: {fillColor: "#fff"}
        }], g))
...
function init_select2() {
    ...
    "undefined" != typeof select2 && (console.log("init_select2"), $(".select2").select2({}))
}
...
function init_SmartWizard() {
    // Step show event
    $("#ts_smartwizard").on("showStep", function(e, anchorObject, stepNumber, stepDirection, stepPosition) {
    ...
    var btnFinish = $('<button></button>').html('<span class="label">Finish</span>')
        .attr({ id:"create_job_submit", type:"submit"})
        .addClass('btn btn-sm btn-defualt')
        .on('click', function(){ addJob(); });
    var btnCancel = $('<a></a>').text('Reset')
    ...
    var btnCancelConfirm = $('<button></button>').text('Reset')
        .addClass('btn btn-sm btn-danger')
        .on('click', function(){ $('#ts_smartwizard').smartWizard("reset"); });


    "undefined" != typeof $.fn.smartWizard && (console.log("init_SmartWizard"), $("#wizard").smartWizard({transitionEffect:'slide'}), $("#wizard_verticle").smartWizard({transitionEffect: "slide"}), $(".buttonNext").addClass("btn btn-success"), $(".buttonPrevious").addClass("btn btn-primary"), $(".buttonFinish").addClass("btn btn-default"),
    // Smart Wizard
    $('#ts_smartwizard').smartWizard({
        selected: 0,
    ...
    //     // Reset wizard
    //     $('#ts_smartwizard').smartWizard("reset");
    //     return true;
    // });

    $("#prev-btn").on("click", function() {
        // Navigate previous
        $('#ts_smartwizard').smartWizard("prev");
        return true;
    }),

    $("#next-btn").on("click", function() {
        // Navigate next
        $('#ts_smartwizard').smartWizard("next");
        return true;
    }))
}
...
$(document).ready(function () {
    ...
    $("input.flat")[0] && $(document).ready(function () {
        $("input.flat").iCheck({checkboxClass: "icheckbox_flat-blue", radioClass: "iradio_flat-blue"})
    })
