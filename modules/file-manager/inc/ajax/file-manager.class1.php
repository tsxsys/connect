...
function fm_show_nav_path($path)
{
    ...
    ?>
    <nav class="navbar navbar-expand-lg <?php echo $getTheme; ?> main-nav">
    ...
    <head>
        ...
        <style>
            ...
            *,*::before,*::after { box-sizing: border-box;}
            ...
            .inline-actions > a > i { font-size:1em;margin-left:5px;background:var(--main_2_theme_colour_1);color:#fff;padding:3px 4px;border-radius:3px; }
