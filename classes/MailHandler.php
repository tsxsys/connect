<?php
/**
* Connect\MailHandler extends AppConfig
*/
namespace Connect;
    ...
    public function sendMail($userarr, $type)
    {
        ...
        if ($type == 'Verify') {
            ...
            foreach ($userarr as $usr) {
                ...
                $verify_url = $this->base_url . "/console/modules/login/verify-user.php?v=1&uid=" . $uid_64;
            ...
            include $this->base_dir."/console/modules/login/partials/mailtemplates/verifyemail.php";

            //Set the subject line
            $mail->Subject = $this->site_name . ' Account Verification';
            ...
            if ($this->admin_verify == true) {
                ...
                $mail->AltBody = $this->verify_email_noadmin . $verify_url;
            }
        } elseif ($type == 'Active') {
            foreach ($userarr as $usr) {
                $mail->AddBCC($usr['email'], $usr['username']);
            ...
            include $this->base_dir."/console/modules/login/partials/mailtemplates/activeemail.php";
    ...
    public function sendResetMail($reset_url, $to_email, $username)
    {
        ...
        try {
          ...
          $mail->SMTPOptions = array(
            ...
            include $this->base_dir."/console/modules/login/partials/mailtemplates/resetemail.php";
