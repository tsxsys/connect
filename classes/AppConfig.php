<?php
/**
 * Connect\Appconfig extends DbConn
 */
...
class AppConfig extends DbConn
{
    ...
    public function __construct()
    {
        ...
        $this->signin_url = $settings['base_url'] . '/views';
    ...
    /**
     * Pulls single setting statically from database without invoking new Connect\AppConfig object. Meant to be used in pages where `pagehead.php` is not included.
     * Calls can be made like so: Connect\AppConfig::pullSetting('setting_name', 'db_var_type')
     *
    ...
    /**
     * Pulls multiple settings statically from database without invoking new Connect\AppConfig object. Meant to be used in pages where `pagehead.php` is not included.
     * Calls can be made like so: `Connect\AppConfig::pullMultiSettings(array("setting1", "setting2", "etc"))`
     *
