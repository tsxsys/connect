<?php
/**
 * Connect\LoginHandler extends AppConfig
 */
    ...
    public function checkLogin($username, $password, bool $cookie = false)
    {
        ...
        try {
            ...
            if ($curr_attempts >= $max_attempts && $timeDiff < $login_timeout) {
                ...
                $success = '<div class="alert alert-success icons-alert"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><i class="icofont icofont-close-line-circled"></i></button><p>Maximum number of login attempts exceeded... please wait ' . $timeout_minutes . ' minutes before logging in again</p></div>';
            } else {
                ...
                if (PasswordHandler::checkPw($password, $result['password']) && $result['verified'] == '1' && $result['banned'] == '0') {
                    ...
                    $success = '<div class="alert alert-danger icons-alert"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><i class="icofont icofont-close-line-circled"></i></button><p>Wrong Username or Password</p></div>';
                }
            }
