<?php
/**
 * Connect\PasswordHandler extends DbConn
 */
namespace Connect;
   ...
   */
    ...
    public function resetPw($uid, $password_raw): array
    {
        try {
            ...
            $resp['message'] = '<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Password Reset! <a href="'.AppConfig::pullSetting("base_url")."/console/modules/login".'">Click here to sign in!</a></div><div id="returnVal" style="display:none;">true</div>';
            $resp['status'] = true;
